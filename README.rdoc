...
Our systems run {PostgreSQL}[http://www.postgresql.org] databases, but you may use any database that Rails supports. If you do not wish to set up PostgreSQL on your development system, use SQLite.
