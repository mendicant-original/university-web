...
<img src="https://github.com/rmu/university-web/raw/master/doc/university-web.png">
...
3. Run <tt>bundle install</tt> to install all of the dependencies
...
3. Generate the static site by running <tt>rake public-site:generate</tt>
